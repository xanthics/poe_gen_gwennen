...
def init_page():
	...
	doc['show_hide'] <= t + DIV(BUTTON("Generate string", Id='generate') + "This will cause many calculations and may take a bit to return a result") + DIV("No strings generated yet.", Id="generated_strings", Class='sec_div grind')
